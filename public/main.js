...
var AppComponent = /** @class */ (function () {
    function AppComponent(router, _flashMessagesService, AuthService) {
        this.router = router;
    ...
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], angular2_flash_messages__WEBPACK_IMPORTED_MODULE_1__["FlashMessagesService"], _service_auth_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"]])
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var _service_register_register_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./service/register/register.service */ "./src/app/service/register/register.service.ts");
...
var appRoutes = [
    ...
    { path: 'profile', component: _profile_profile_component__WEBPACK_IMPORTED_MODULE_12__["ProfileComponent"], canActivate: [_guard_auth_guard__WEBPACK_IMPORTED_MODULE_15__["AuthGuard"]] },
    { path: 'dashboard', component: _dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_11__["DashboardComponent"], canActivate: [_guard_auth_guard__WEBPACK_IMPORTED_MODULE_15__["AuthGuard"]] },
];
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [_service_register_register_service__WEBPACK_IMPORTED_MODULE_13__["RegisterService"], _service_auth_auth_service__WEBPACK_IMPORTED_MODULE_14__["AuthService"], _guard_auth_guard__WEBPACK_IMPORTED_MODULE_15__["AuthGuard"]],
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(router, _flashMessagesService, AuthService) {
        this.router = router;
        this._flashMessagesService = _flashMessagesService;
        this.AuthService = AuthService;
    }
    ...
    LoginComponent.prototype.onSubmit = function () {
        ...
        // console.log(user);
        this.AuthService.validateUser(user).subscribe(function (data) {
            // console.log(data);
            if (data.success) {
...
var ProfileComponent = /** @class */ (function () {
    function ProfileComponent(router, AuthService, _flashMessagesService) {
        this.router = router;
        this.AuthService = AuthService;
        this._flashMessagesService = _flashMessagesService;
    }
    ...
    ProfileComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _service_auth_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"], angular2_flash_messages__WEBPACK_IMPORTED_MODULE_1__["FlashMessagesService"]])
    ], ProfileComponent);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _service_register_register_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../service/register/register.service */ "./src/app/service/register/register.service.ts");
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(router, AuthService, RegisterService, _flashMessagesService) {
        this.router = router;
        this.AuthService = AuthService;
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.AuthService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this._flashMessagesService.show('You are now registered and can now login', { cssClass: 'alert-success', timeout: 3000 });
    ...
    RegisterComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], _service_auth_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"], _service_register_register_service__WEBPACK_IMPORTED_MODULE_1__["RegisterService"], angular2_flash_messages__WEBPACK_IMPORTED_MODULE_2__["FlashMessagesService"]])
    ], RegisterComponent);
...
var RegisterService = /** @class */ (function () {
    ...
    RegisterService.prototype.validateRegister = function (user) {
...
module.exports = __webpack_require__(/*! /home/meet-cric/Desktop/MEAN_STACK/angular-src/src/main.ts */"./src/main.ts");
